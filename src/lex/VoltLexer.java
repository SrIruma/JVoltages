...
public class VoltLexer {
    ...
    public VoltLexer(String source) {
        this.source = source;
    }
        ...
        switch (c) {
            ...
            default:
                if (isDigit(c)) {
                    ...
                    voltRuntime.error(line, "Unexpected character.");
                }
        }
    }
    ...
    private void scanString() {
        ...
        if (isAtEnd()) {
            voltRuntime.error(line, "Unterminated scanString.");
            return;
        }
    ...
    private void scanChar() {
        ...
        pointToNextChar();
        if (getCurrentChar() != '\'') {
            voltRuntime.error(line, "Unterminated char variable.");
            return;
        }
        pointToNextChar();
