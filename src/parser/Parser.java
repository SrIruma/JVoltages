 ...
 */
    ...
    private Statement nativeFuncDeclaration() {
        ...
        while (match(COLON)) {
            Token token = new Token(DOT, ".",null, moduleName.line);
    ...
    private Expression ternaryExp(){
        ...
        if (match(QUESTION_MARK)) {
            ...
            voltRuntime.error(colon,"Expected Expression after COLON");
        }
        return expr;
    }
    ...
    private Expression primary() {
        ...
        if (match(NULL)) return new LiteralExp(null);
    ...
    private ParseError error(Token token, String message) {
        voltRuntime.error(token.line, message);
